...
-- -----------------------------------------------------
-- Table `new_schema1`.`Attachments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`Attachments` (
  `idAttachments` INT NOT NULL AUTO_INCREMENT,
  `Type` VARCHAR(45) NULL,
  `Path` VARCHAR(255) NULL,
  `Post_idPost` INT NOT NULL,
  `Post_UserProfile_idUserProfile` INT NOT NULL,
  PRIMARY KEY (`idAttachments`, `Post_idPost`, `Post_UserProfile_idUserProfile`),
  INDEX `fk_Attachments_Post1_idx` (`Post_idPost` ASC, `Post_UserProfile_idUserProfile` ASC),
  CONSTRAINT `fk_Attachments_Post1`
    FOREIGN KEY (`Post_idPost` , `Post_UserProfile_idUserProfile`)
